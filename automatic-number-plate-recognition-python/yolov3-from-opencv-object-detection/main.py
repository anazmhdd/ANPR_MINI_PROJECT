...
# class_names_path = r'C:\Users\Mohammed Anas\Desktop\test3\automatic-number-plate-recognition-python\model\class.names'
# class_names_path = os.path.join('.', 'model', 'class.names')

script_dir = os.path.dirname(os.path.realpath(__file__))

# Construct the correct path to the 'class.names' file
...
print(f"Trying to open: {class_names_path}")

input_dir = 'C:\\Users\\Mohammed Anas\\Desktop\\test3\\automatic-number-plate-recognition-python\\data'
